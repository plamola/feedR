...
import akka.actor._
import nl.dekkr.feedr.common.Error
import nl.dekkr.feedr.domain.AggregateRoot
import nl.dekkr.feedr.domain.AggregateRoot.{Removed, Uninitialized}
import nl.dekkr.feedr.service.AggregateManager
