...
import nl.dekkr.feedr.domain.AggregateRoot.Removed
import nl.dekkr.feedr.domain.VehicleAggregate
...
import nl.dekkr.feedr.service.UserAggregateManager.RegisterUser
